...
class Settings(BaseSettings):
    # Database
    DATABASE_URL: str = "postgresql+asyncpg://postgres:postgres@postgres:5432/roastmybook"
    ...
    # Product pricing
    PRODUCTS: dict = {
        "roast_pack_3": {"price": 799, "generations": 3},
        "roast_pack_10": {"price": 1999, "generations": 10},
    }
